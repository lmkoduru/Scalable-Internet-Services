...
class DedupeCommand extends cli_1.BaseCommand {
    constructor() {
        super(...arguments);
        this.strategy = clipanion_1.Option.String(`-s,--strategy`, dedupeUtils.Strategy.HIGHEST, {
            description: `The strategy to use when deduping dependencies`,
            validator: t.isEnum(dedupeUtils.Strategy),
        });
        this.check = clipanion_1.Option.Boolean(`-c,--check`, false, {
    ...
    async execute() {
        ...
        const dedupeReport = await core_1.StreamReport.start({
            configuration,
            includeFooter: false,
...
DedupeCommand.usage = clipanion_1.Command.Usage({
