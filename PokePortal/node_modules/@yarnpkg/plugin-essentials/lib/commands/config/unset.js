...
class ConfigUnsetCommand extends cli_1.BaseCommand {
    constructor() {
        super(...arguments);
        this.home = clipanion_1.Option.Boolean(`-H,--home`, false, {
    ...
    async execute() {
        ...
        const report = await core_1.StreamReport.start({
            ...
            if (!bailedOutEarly) {
                report.reportInfo(core_1.MessageName.UNNAMED, `Successfully unset ${this.name}`);
            }
        });
...
ConfigUnsetCommand.usage = clipanion_1.Command.Usage({
