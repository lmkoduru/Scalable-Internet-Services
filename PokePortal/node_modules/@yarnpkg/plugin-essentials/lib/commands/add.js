...
class AddCommand extends cli_1.BaseCommand {
    constructor() {
        ...
        this.tilde = clipanion_1.Option.Boolean(`-T,--tilde`, false, {
            description: `Use the \`~\` semver modifier on the resolved range`,
        });
        this.caret = clipanion_1.Option.Boolean(`-C,--caret`, false, {
            description: `Use the \`^\` semver modifier on the resolved range`,
        });
        this.dev = clipanion_1.Option.Boolean(`-D,--dev`, false, {
            description: `Add a package as a dev dependency`,
        });
        this.peer = clipanion_1.Option.Boolean(`-P,--peer`, false, {
            description: `Add a package as a peer dependency`,
        });
        this.optional = clipanion_1.Option.Boolean(`-O,--optional`, false, {
