...
exports.verifyHunkIntegrity = exports.parsePatchFile = exports.interpretParsedPatchFile = exports.PatchMutationType = exports.EXECUTABLE_FILE_MODE = exports.NON_EXECUTABLE_FILE_MODE = exports.parseHunkHeaderLine = exports.getPath = void 0;
const core_1 = require("@yarnpkg/core");
const fslib_1 = require("@yarnpkg/fslib");
const HEADER_REGEXP = /^@@ -(\d+)(,(\d+))? \+(\d+)(,(\d+))? @@.*/;
function getPath(p) {
    return fslib_1.ppath.relative(fslib_1.PortablePath.root, fslib_1.ppath.resolve(fslib_1.PortablePath.root, fslib_1.npath.toPortablePath(p)));
}
...
})(PatchMutationType || (exports.PatchMutationType = PatchMutationType = {}));
    ...
    for (let i = 0; i < lines.length; i++) {
        ...
        if (state === `parsing header`) {
            ...
            switch (lineType) {
                ...
                default:
                    {
                        core_1.miscUtils.assertNever(lineType);
                    }
                    break;
            }
        }
...
function interpretParsedPatchFile(files) {
    ...
    for (const file of files) {
        const { semverExclusivity, diffLineFromPath, diffLineToPath, oldMode, newMode, deletedFileMode, newFileMode, renameFrom, renameTo, beforeHash, afterHash, fromPath, toPath, hunks, } = file;
        ...
        switch (type) {
            ...
            default:
                {
                    core_1.miscUtils.assertNever(type);
                }
                break;
        }
